      ...
      <main id="auth-main" className="auth-main">
        <div className="container">
          <div className="auth-card hero-panel">
            ...
            <p className="auth-lead">Создайте аккаунт клиента клиники.</p>
            <form className="form" onSubmit={onSubmit}>
              ...
              <label className="field">
                ...
                <input className="input" type="text" name="fullName" autoComplete="name" required />
              </label>
              <label className="field">
              ...
              <label className="field">
                <span className="field-label">Телефон (необязательно)</span>
                <input className="input" type="tel" name="phone" autoComplete="tel" />
              </label>
              <label className="field">
                <span className="field-label">Пароль (не меньше 6 символов)</span>
                <input
                  className="input"
                  type="password"
                  name="password"
